...
const FadeInWords: React.FC<FadeInWordsProps> = (props: FadeInWordsProps) => {
  const { children, integrationSource, isStreaming, messageIndex, showCodeBorder, ...otherProps } = props;
...
const FadeInElement: React.FC<FadeInElementProps> = (props: FadeInElementProps) => {
  const { children, integrationSource, isStreaming, messageIndex, showCodeBorder, as = 'p', ...otherProps } = props;
