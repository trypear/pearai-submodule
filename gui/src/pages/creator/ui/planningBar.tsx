...
export const PlanningBar: FC<PlanningBarProps> = ({ isGenerating, requestedPlan, playCallback, nextCallback, className }) => {

    return (
        <div className={cn("bg-[#161718] w-full rounded-full flex text-white justify-between min-w-64 h-10 gap-4 relative", className)}>
