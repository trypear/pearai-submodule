...
function ConfigureProvider() {
  ...
  const [watsonxAuthenticate, setWatsonxAuthenticate] = useState(true);
          ...
          {providerName === "pearai_server" ? (
            <>
              ...
              <small
                ...
                className="mx-3"
              >
                Note: Having trouble logging in? Open PearAI from the dashboard
                on the{" "}
                <a
                      ...
                      <ModelCard
                        ...
                        onClick={(e, dimensionChoices) => {
                          ...
                          for (const d of modelInfo.collectInputFor || []) {
                            ...
                            formParams = updatedObj(formParams, {
                              [d.key]:
                                d.inputType === "text" ? val : parseFloat(val),
                            });
                          }
