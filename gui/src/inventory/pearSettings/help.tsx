...
import { Link2, Link2Icon, LucideExternalLink, ChevronRight } from "lucide-react";
...
const HelpSettings = () => {
    return (
        <div className="border border-solidd w-full p-5 flex-col justify-start items-start gap-5 inline-flex overflow-hidden">
            ...
            <div className="self-stretch pb-2 flex-col justify-start items-start gap-3 flex">
                <div className="self-stretch opacity-50  text-[10px] font-bold font-['SF Pro'] tracking-tight">REACH US</div>
